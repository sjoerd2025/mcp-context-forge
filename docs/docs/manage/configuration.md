...
| `PROTECT_ALL_ADMINS`          | Prevent any admin from being locked out via API/UI | `true`  |
...
| `PROTECT_ALL_ADMINS`                   | Prevent any admin from being locked out via API/UI. When false, only the last active admin is protected. | `true`                   | bool     |
