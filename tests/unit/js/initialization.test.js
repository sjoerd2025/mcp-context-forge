...
describe("initializeSearchInputs", () => {
  ...
  test("calls queueSearchablePanelReload immediately when panel visible and has query", () => {
    getPanelSearchStateFromUrl.mockReturnValue({ query: "search", tags: "" });
    ...
    expect(queueSearchablePanelReload).toHaveBeenCalledWith("tools", 0);
  });
